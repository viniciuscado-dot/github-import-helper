...
import { Sparkles, Eye, Clock, Building2, FileText, ArrowRight, RefreshCw } from 'lucide-react';
...
interface AnaliseResultsRecentProps {
...
export function AnaliseResultsRecent({ briefings, onView, onViewHistory, onGenerate, canCreate, isGenerating, isEmpty }: AnaliseResultsRecentProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Análises geradas com IA</p>
        </div>
      ...
      {isEmpty || recentBriefings.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-sm text-muted-foreground/70 mt-1">
            Preencha o formulário e gere sua primeira análise
          </p>
        </div>
      ) : (
        <>
